...
1. ブラウザで次のアドレスを開きます。インストールも登録も要りません。`https://typa.giga-school.com/`
2. 校内のフィルタリングで許可が要るのは `typa.giga-school.com` だけです。ほかの外部サイトを1つも読みません。広告も、外部のフォントも、記録を送る先もありません。
...
1. ブラウザで `https://typa.giga-school.com/` を開きます。もうお題が出ています。
